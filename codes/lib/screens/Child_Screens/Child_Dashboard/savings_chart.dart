...
class SavingsSparkline
  ...
  const SavingsSparkline({
    ...
    this.emptyTextColor = AppColors.kTextSoft,
    this.axisTextColor = AppColors.kTextSoft,
  });
  ...
  State<
    SavingsSparkline
  >
  createState() => _SavingsSparklineState();
}

class _SavingsSparklineState
    extends
        State<
          SavingsSparkline
        > {
...
class _Bubble
  ...
  Widget build(
    ...
    final rawLabel = parts.isNotEmpty
        ? parts[0].trim()
        : '';
    final label =
        months[rawLabel] ??
