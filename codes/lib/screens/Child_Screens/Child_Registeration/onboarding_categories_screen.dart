...
class OnboardingCategoriesScreen
    extends
        StatefulWidget {
  ...
  >
  createState() => _OnboardingCategoriesScreenState();
}
                        ...
                        child: Column(
                          children: [
                            ...
                            _CategoryTile(
                              ...
                              bgColor: AppColors.kYellow.withOpacity(
                                0.15,
                              ),
                              borderColor: AppColors.kYellow.withOpacity(
                                0.45,
                              ),
                            ),
                            const SizedBox(
                            ...
                            _CategoryTile(
                              ...
                              bgColor: AppColors.kPurple.withOpacity(
                                0.12,
                              ),
                              borderColor: AppColors.kPurple.withOpacity(
                                0.4,
                              ),
                            ),
                            const SizedBox(
                            ...
                            _CategoryTile(
                              ...
                              bgColor: AppColors.kBlue.withOpacity(
                                0.12,
                              ),
                              borderColor: AppColors.kBlue.withOpacity(
                                0.4,
                              ),
                            ),
                          ],
