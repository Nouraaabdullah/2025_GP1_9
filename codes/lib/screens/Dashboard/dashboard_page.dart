...
class _DashboardPageState
  ...
  _loadAll() async {
    ...
    try {
      ...
      // Weekly mode: take the current month's total and divide by 4
      {
        ...
        if (_periodIndex ==
          ...
          for (
            ...
            final ti = _totalIncomeFromMfrOn(
              DateTime(
                y,
                m,
                1,
      ...
      for (final r in fixedExpenseRows) {
        ...
        for (
          ...
          if (_periodIndex ==
              2) {
            final y = buckets[i].year!;
            final monthsActive = _monthsActiveByPayday(
              st,
              en,
              y,
              dueDay,
      ...
      Future<
        void
      >
      _loadCategorySlicesMonthly() async {
      ...
      Future<
        void
      >
      _loadCategorySlicesYearly() async {
  ...
  Widget build(
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SurraBottomBar(
        onTapDashboard: () => Navigator.pushReplacementNamed(
          context,
          '/dashboard',
        ),
        onTapSavings: () => Navigator.pushReplacementNamed(
          context,
          '/savings',
        ),
        onTapProfile: () => Navigator.pushReplacementNamed(
          context,
          '/profile',
        ),
      ),
  ...
  Widget _buildBody(
    ...
    final trendsTotalExpenses =
        _seriesExpenses.fold<
          num
        >(
          0,
          (
    ...
    final trendsTotalEarnings =
        _seriesEarnings.fold<
          num
        >(
          0,
          (
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
              height: _betweenTitleAndCard,
            ),
            _SectionCard(
              onInfo: () => _showInfo(
                context,
                'This chart tracks how efficiently you’re managing your income this ${_periodIndex == 0
                    ? 'week'
                    : _periodIndex == 1
                    ? 'month'
                    : 'year'}. It shows what portion of your total funds (earnings + income) is still available after spending. The purple gauge shows how much of your income remains after all expenses.',
              ),
              child: Column(
                children: [
                  const SizedBox(
                    ...
                    child: SizedBox(
                      width: max(
                        ...
                        _bucketLabels.length *
                            60, // 60px per month/year, adjust as needed
                      ),
            ...
            _SectionCard(
              onInfo: () => _showInfo(
                context,
                'This chart visualizes how your savings evolve across each ${_periodIndex == 0
                    ? 'week'
                    : _periodIndex == 1
                    ? 'month'
                    : 'year'}. By connecting these points, the chart highlights your overall savings trend; whether you’re improving, staying steady, or overspending. Use it to spot changes in your saving habits.',
              ),
              child: Padding(
                padding: const EdgeInsets.only(
                  top: 30,
...
class _WeeklyMiniCategoryGrid
  ...
  final List<
    ...
    >
  >
  weeklySlices; // length 4
  final List<
    num
  >
  weeklyTotals; // length 4
  final List<
    bool
  >
  weekIsFuture; // length 4
