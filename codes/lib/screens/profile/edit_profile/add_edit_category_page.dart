...
class AddEditCategoryPage
  ...
  State<
    AddEditCategoryPage
  >
  createState() => _AddEditCategoryPageState();
}
...
class _AddEditCategoryPageState
  ...
  _isCategoryNameDuplicate(
    ...
    try {
      ...
      debugPrint(
        'Error checking duplicate category name: $e',
      );
      return false;
    }
  }
  ...
  _isColorDuplicate(
    ...
    try {
      ...
      debugPrint(
        'Error checking duplicate color: $e',
      );
      return false;
    }
  }
  ...
  _saveCategory() async {
    ...
    final isNameDuplicate = await _isCategoryNameDuplicate(
      name,
    );
    if (isNameDuplicate) {
      _showError(
    ...
    final isColorDuplicate = await _isColorDuplicate(
      _selectedColor,
    );
    if (isColorDuplicate) {
      _showError(
                                    ...
                                    onChanged:
                                        (
                                          ...
                                          setDialogState(
                                            () {
                                              brightness = v;
                                              HSVColor hsv = HSVColor.fromColor(
                                                tempColor,
                                              );
                                              tempColor = hsv
                                                  .withValue(
