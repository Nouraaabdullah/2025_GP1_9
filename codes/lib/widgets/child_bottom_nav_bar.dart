...
import '../screens/Child_Screens/Child_Log/log_transaction_manually.dart'
    show
        ChildLogTransactionManuallyPage;
import '../screens/chatbot/chatbot_screen.dart';
import '../screens/Child_Screens/Child_Dashboard/dashboard_page.dart' as child_dashboard;
import '../utils/auth_helpers.dart';

// ── Kid theme colours ─────────────────────────────────────────────────────────
const _kPurple = Color(
  0xFF8B5CF6,
);
const _kTextSoft = Color(
  0xFF7C6FA0,
);
const _kText = Color(
  0xFF2D1B69,
);
const _kCardBg = Color(
  0xFFF5F0FF,
);

class ChildBottomBar
    extends
        StatelessWidget {
                                ...
                                () => Navigator.pushReplacement(
                                  ...
                                  MaterialPageRoute(
                                    builder:
                                        (
                                          _,
                                        ) => const child_dashboard.DashboardPage(),
                                  ),
                                ),
                          ),
                        ),
                    ...
                    Navigator.of(
                      ...
                      MaterialPageRoute(
                        builder:
                            (
                              _,
                            ) => const ChildLogTransactionManuallyPage(),
...
class _FabButton
  ...
  State<
    _FabButton
  >
  createState() => _FabButtonState();
}

class _FabButtonState
    extends
        State<
          _FabButton
        > {
